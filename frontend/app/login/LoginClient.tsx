      ...
      if (isNative) {
        ...
        if (provider === 'google') {
          ...
          if (user) {
            ...
            const dest = !profile?.alias ? '/onboarding' : (isSafeRedirect ? redirect! : '/dashboard')
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full border border-[#EEEEEE] bg-[#F4F4F4] px-4 py-3 pr-11 text-sm text-[#111111] placeholder-[#AAAAAA] transition-colors focus:border-[#CC4B37] focus:outline-none"
                />
                <button
                  type="button"
