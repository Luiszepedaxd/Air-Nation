...
const BLOQUES: BloqueDef[] = [
  ...
  },
  {
    ...
    descripcion: 'Grid 2×2 de pases individuales + team pass + CTA AEM. Para marcar AGOTADO, escribe "agotado" o "venta finalizada" en el campo de estado correspondiente.',
    campos: [
      ...
      { key: 'pase_individual_estado', label: 'Pase Individual — Estado (vacío = en venta · "agotado" o "venta finalizada" = AGOTADO)', tipo: 'texto', placeholder: 'Dejar vacío si está en venta' },
      { key: 'team_pass_precio', label: 'Team Pass — Precio', tipo: 'texto', placeholder: '$4,998' },
      { key: 'team_pass_comision', label: 'Team Pass — Comisión', tipo: 'texto', placeholder: '+$124.95' },
      { key: 'team_pass_estado', label: 'Team Pass — Estado (vacío = en venta · "agotado" o "venta finalizada" = AGOTADO)', tipo: 'texto', placeholder: 'Dejar vacío si está en venta' },
      { key: 'fecha_cierre_venta', label: 'Fecha cierre venta', tipo: 'texto', placeholder: '10 mayo, 11:50 p.m.' },
      { key: 'cta_texto', label: 'Botón (texto) — se ignora si TODO está agotado', tipo: 'texto', placeholder: 'COMPRAR EN AIRSOFTEXPERIENCEMEXICO.COM' },
